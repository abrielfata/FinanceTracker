...
export default function NotificationDropdown() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-[280px] sm:w-80 max-w-[calc(100vw-2rem)] bg-white rounded-2xl shadow-premium border border-premium-border overflow-hidden z-50 animate-in fade-in zoom-in duration-200 origin-top-right">
